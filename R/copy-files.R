...
#'
#' @param target_path directory to import template files to
#'
#' @export
import_template_files <- function(target_path = NULL) {
  ...
  # This should prevent the user from accidentally copying the
  # template files to the wrong directory
